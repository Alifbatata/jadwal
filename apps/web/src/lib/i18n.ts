...
const ar: Dictionnaire = {
	...
	noCourses: 'لا دروس منشورة حالياً.',
	allAudiences: 'الكل',
	place: 'المكان',
	teacher: 'المدرّس',
	...
	subscribeIntro: (name) =>
		`يُضاف برنامج ${name} إلى تقويمك ويتحدّث تلقائياً، مرة كل ساعة تقريباً. لا حاجة لإعادة أي إعداد عند تغيّر درس.`,
	subscribeButton: 'أضف إلى تقويمي',
	subscribeAddress: 'أو انسخ هذا العنوان في تطبيق التقويم:',
	subscribeWholeTitle: 'البرنامج كاملاً',
	subscribeOneCourseTitle: 'درس واحد فقط',
	subscribeOneCourseText:
		'يمكنك أيضاً إضافة درس واحد فقط. اضغط على اسمه: يُضاف وحده ويتحدّث مثل الباقي. وعنوانه بصيغة https موجود في صفحة الدرس.',
	subscribeWhole: 'الاشتراك في البرنامج كاملاً',
