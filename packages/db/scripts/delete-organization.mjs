...
function ceQuiReste({ restes }) {
	...
	lignes.push(
		...
		`    dernière archive qui contient l'organisation part 182 jours au plus après sa création :`,
		`    le cycle de vie l'efface à 181 jours, et le stockage peut mettre un jour à le faire`,
